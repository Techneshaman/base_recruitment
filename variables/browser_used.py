...
class BrowserUsed(Variable):

    def __init__(self, metric='count'):
        Variable.__init__(self)
        self.variable_data = {}
        self.variable_name = 'BrowserUsed_%s' % metric
        self.metric = metric
    ...
    def on_data_point(self, data_point):
        ...
        if browser_used not in self.variable_data[user_id]:
            self.variable_data[user_id][browser_used] = 0
        self.variable_data[user_id][browser_used] += 1
